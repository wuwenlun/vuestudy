<template>
    <div class="invite-poster-page" v-bind:style="{ width:clientWidth+'px' }">
        ...
        <div v-if="!hiddenAction" style="position: absolute" v-bind:style="{top:changeImgYDistance+'px', left:changeImgXDistance+'px'}">
        ...
        <div v-if="!hiddenAction" style="position: absolute" v-bind:style="{top:changeNameYDistance+'px', left:changeNameXDistance+'px'}">
        ...
        <div class="post-box" v-bind:style="{ width: postBoxWidth+'px', minHeight:clientHeight+'px' }">
                ...
                <div class="texter" v-bind:style="{ height:texterHeight+'px', top: texterDistance+'px' }">
                    <div style="position: relative; width:100%; height: 100%;">
                        <div class="texterMiddle">
                            <div v-bind:style="{height:(texterHeight/2)+'px', lineHeight:(texterHeight/2)+'px'}">
                                <span style="color:#E7DA71">我是</span>
                                <span style="margin-left:0px;letter-spacing:2px;font-weight: 800;font-size: 18px;">
                            ...
                            <div style="margin-left: 70px;margin-top: 0px;">
                                我是第<span style="color:#E7DA71; margin: 0 5px">{{number}}</span>位代言人
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="footer" v-bind:style="{ minHeight:footerHeight+'px' }">
                <div class="footer-contenter">
                    <van-button  v-show="!hiddenAction" type="primary" style="width: 10rem" @click="createImage">生成</van-button>
                </div>
            </div>
        </div>
    </div>
...
<script>
    ...
    export default {
        ...
        created() {
            ...
            this.headbgHeight = this.postBoxWidth/2.29;
            this.footbgHeight = this.postBoxWidth/1.7;
            this.texterHeight = this.postBoxWidth/5.9;
            this.texterDistance = this.contenterHeight/1.49;
        ...
        methods: {
            ...
            createImage() {
                ...
                html2canvas(shareContent, opts).then(function (canvas) {
                    ...
                    a.width = width;
                    a.height = height;
                    console.info(document.querySelector(".post-box"));
                    document.querySelector(".post-box").appendChild(a);
