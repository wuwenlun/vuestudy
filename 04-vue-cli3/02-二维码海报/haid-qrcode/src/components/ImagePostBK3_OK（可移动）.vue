        ...
        <div class="post-box" v-bind:style="{ width: postBoxWidth+'px', minHeight:clientHeight+'px' }">
            <div class="contenter" v-bind:style="{ minHeight:contenterHeight+'px' }">
                ...
                <div class="imgbg" style="{ height:100% }">
                    <div class="dragdiv">
                        <img style="position: relative;" v-bind:src="imageSrc" v-bind:style="{width:imgWidthInit+'px', height:imgHeightInit+'px'}" draggable="true" @mousedown="down" @touchstart="down" @mousemove="move" @touchmove="move" @mouseup="end" @touchend="end">
                    </div>
                </div>
