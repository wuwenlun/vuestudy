                    ...
                    <div style="position: relative; width:100%; height: 100%;">
                        <div class="texterMiddle">
                            <div>
                                ...
                                <span style="margin-left:0px;letter-spacing:4px;font-weight: 800;font-size: 23px;">
...
<script>
    ...
    export default {
        ...
        created() {
            ...
            this.headbgHeight = this.postBoxWidth/2.18;
            this.footbgHeight = this.postBoxWidth/1.5;
            this.texterHeight = this.postBoxWidth/5;
            this.texterDistance = this.contenterHeight/1.6;
